...
struct PlayerSettings: View {
    ...
    private var sections: some View {
        Group {
            Section(header: SettingsHeader(text: NSLocalizedString("Playback", tableName: "Localizable", bundle: .main, comment: ""))) {
                sourcePicker
            ...
            #if !os(tvOS)
                Section(header: SettingsHeader(text: NSLocalizedString("Controls", tableName: "Localizable", bundle: .main, comment: "")), footer: controlsLayoutFooter) {
                    horizontalPlayerGestureEnabledToggle
                    SettingsHeader(text: NSLocalizedString("Seek gesture sensitivity", tableName: "Localizable", bundle: .main, comment: ""), secondary: true)
                    seekGestureSensitivityPicker
                    SettingsHeader(text: NSLocalizedString("Seek gesture speed", tableName: "Localizable", bundle: .main, comment: ""), secondary: true)
                    seekGestureSpeedPicker
                    SettingsHeader(text: NSLocalizedString("Regular size", tableName: "Localizable", bundle: .main, comment: ""), secondary: true)
                    playerControlsLayoutPicker
                    SettingsHeader(text: NSLocalizedString("Fullscreen size", tableName: "Localizable", bundle: .main, comment: ""), secondary: true)
            ...
            #if os(iOS)
                Section(header: SettingsHeader(text: NSLocalizedString("Orientation", tableName: "Localizable", bundle: .main, comment: ""))) {
                    if idiom == .pad {
            ...
            Section(header: SettingsHeader(text: NSLocalizedString("Picture in Picture", tableName: "Localizable", bundle: .main, comment: ""))) {
    ...
    private var systemControlsCommandsPicker: some View {
        func labelText(_ label: String) -> String {
            #if os(macOS)
                String(format: NSLocalizedString("System controls show buttons for %@", tableName: "Localizable", bundle: .main, comment: ""), label)
            #else
                label
            #endif
        }
        ...
        return Picker("System controls buttons", selection: $systemControlsCommands) {
            Text(labelText(NSLocalizedString("10 seconds forwards/backwards", tableName: "Localizable", bundle: .main, comment: ""))).tag(SystemControlsCommands.seek)
            Text(labelText(NSLocalizedString("Restart/Play next", tableName: "Localizable", bundle: .main, comment: ""))).tag(SystemControlsCommands.restartAndAdvanceToNext)
        }
