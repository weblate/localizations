...
struct BrowsingSettings: View {
    ...
    private var thumbnailsSettings: some View {
        Section(header: SettingsHeader(text: NSLocalizedString("Thumbnails", tableName: "Localizable", bundle: .main, comment: ""))) {
    ...
    private var visibleSectionsSettings: some View {
        Section(header: SettingsHeader(text: NSLocalizedString("Sections", tableName: "Localizable", bundle: .main, comment: ""))) {
            #if os(macOS)
